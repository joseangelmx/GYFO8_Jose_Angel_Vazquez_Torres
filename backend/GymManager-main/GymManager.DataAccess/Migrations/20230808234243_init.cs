        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipEnd = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mesure = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesInventories", x => new { x.InventoryId, x.SaleId });
                    table.ForeignKey(
                        name: "FK_SalesInventories_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesInventories_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInventories_SaleId",
                table: "SalesInventories",
                column: "SaleId");
        }
